...
function addToCart(goodsId, parentId, isnowbuy)
{
  ...
  document.cookie="one_step_buy="+one_buy;//打标识
  ...
  if(isSelectAttr(spec_arr)){
	  ...
	  var taozi = Ajax.call('flow.php?step=add_to_cart', 'goods=' +  $.toJSON(goods),addToCartResponse, 'POST', 'JSON');
	  if(!taozi)
	  {
...
/* 组合购买__添加商品到购物车__Start     by www.aibangnong.net  */
...
/* 组合购买__添加商品到购物车__End     by www.aibangnong.net */
...
function addToCartResponse(result)
{
  ...
  else
  {
    ...
    document.getElementById('redpoint').innerHTML = document.getElementById('cart_goods_number').innerHTML;
...
function signInResponse(result)
{
 ...
 /* 代码增加_start by www.aibangnong.net */ 
/* *
 * 咨询的翻页函数
 */
...
{ 
 ...
 /* 代码增加_end by www.aibangnong.net */

/* 代码修改_start  整个替换掉即可  by www.aibangnong.net */
/* *
 * 评论的翻页函数
 */
...
/* 代码修改_end by www.aibangnong.net */
 ...
 * 添加礼包到购物车
 */
/* 代码修改_start by aibangnong  这里增加了一个变量 */
function addPackageToCart(packageId, indexId) 
{
  ...
  /* 代码增加_end by aibangnong */
  Ajax.call('flow.php?step=add_package_to_cart', 'package_info=' + $.toJSON(package_info), addPackageToCartResponse, 'POST', 'JSON');
}
/* 代码修改_end by aibangnong */
/* *
 * 处理添加礼包到购物车的反馈信息
 */
