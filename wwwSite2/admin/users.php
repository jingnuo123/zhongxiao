...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $filter = page_and_size($filter);
				/* 代码增加2014-12-23 by www.68ecshop.com  _star */
        //$sql = "SELECT user_id, user_name, email, is_validated, validated,status,user_money, frozen_money, rank_points, pay_points, reg_time ". 
		$sql = "SELECT user_id, user_name, email, is_validated, user_money, frozen_money, rank_points, pay_points, status, reg_time, froms ".
		        /* 代码增加2014-12-23 by www.68ecshop.com  _end  */
